Note: this library has been rewritten from the ground up as [cryptotrader-core](https://github.com/robsaunders/cryptotrailer-core). It is a much better library, please check that instead.
